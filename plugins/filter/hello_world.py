"""A hello-world filter plugin in testnamespacea.testnamespacecol."""
...
DOCUMENTATION = """
    name: hello_world
    author: Testnamespacea Testnamespacecol
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | testnamespacea.testnamespacecol.hello_world }}"
"""
